...
export default function MapComponent(props) {
  ...
  return (
    <div>
      {props.locationError ? <Alert variant='warning'>Enable location detection to see toilets near you</Alert> : null}
      {props.error ? <Alert variant='danger'>Unfortunately there was an error loading toilet data</Alert> : null}
      <Map
